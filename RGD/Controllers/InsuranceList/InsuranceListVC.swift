...
class InsuranceListTblCell: UITableViewCell {
...
class InsuranceListVC: UIViewController {
    ...
    func insuranceListAPI() {
        
        /*
         ===========API CALL===========
         
         Method Name : insurance_plan
        ...
        WSHelper.sendRequestWithURL(wsUrl: "\(kAPIBaseURL)/insurance_plan", method: .post, param: params, header: headersT, isDebug: true) { (resPonse) in
...
extension InsuranceListVC : UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "InsuranceListTblCell", for: indexPath) as! InsuranceListTblCell
        let obj = self.arrData[indexPath.row]
        
        cell.lblTitle.text = obj.name
//        cell.imgMedicine.image = UIImage(named: "IMGBGLogo")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let obj = self.arrData[indexPath.row]
        let nextVC = kMainBoard.instantiateViewController(withIdentifier: "MedicineListVC") as! MedicineListVC
//        nextVC.objData = obj
        nextVC.insuranceID = "\(obj.id!)"
